...
#pragma omp parallel for
  char RST_AI1 = 0;
  RST_AI1 |= !((data + 514 > mean + 512)
  || (mean + 1 > data + 262655));
  RST_AI1 |= !((data + 514 > symmat + 262655)
  || (symmat + 514 > data + 262655));
  RST_AI1 |= !((mean + 1 > symmat + 262655)
  || (symmat + 514 > mean + 512));
  #pragma omp target data map(tofrom: data[514:262655],mean[1:512],symmat[514:262655]) if(!RST_AI1)
  {
