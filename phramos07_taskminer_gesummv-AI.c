...
void gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y, DATA_TYPE *tmp)
{
  ...
  #pragma acc data copy(x[0:8192],y[0:8192],tmp[0:8192],B[0:67117056],A[0:67117056])
  #pragma acc kernels
...
void gesummv_OMP(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y, DATA_TYPE *tmp)
{
  ...
  #pragma acc data copy(tmp[0:8192],A[0:67117056],B[0:67117056],x[0:8192],y[0:8192])
  #pragma acc kernels
  #pragma acc loop independent
  for (i = 0; i < N; i++)
    {
...
void compareResults(DATA_TYPE* y, DATA_TYPE* y_outputFromGpu)
{
  ...
  #pragma acc data copy(y[0:8192],y_outputFromGpu[0:8192])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i=0; i<(N); i++) 
