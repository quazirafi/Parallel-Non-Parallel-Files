...
#pragma omp parallel for
  char RST_AI1 = 0;
  RST_AI1 |= !((data + 2050 > mean + 2048)
  || (mean + 1 > data + 4196351));
  RST_AI1 |= !((data + 2050 > symmat + 4196351)
  || (symmat + 2050 > data + 4196351));
  RST_AI1 |= !((mean + 1 > symmat + 4196351)
  || (symmat + 2050 > mean + 2048));
  #pragma omp target data map(tofrom: data[2050:4196351],mean[1:2048],symmat[2050:4196351]) if(!RST_AI1)
  {
