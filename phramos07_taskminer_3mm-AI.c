...
void init_array(DATA_TYPE* A, DATA_TYPE* B, DATA_TYPE* C, DATA_TYPE* D)
{
  ...
  #pragma acc data copy(A[0:262656])
  #pragma acc kernels
  ...
  #pragma acc data copy(B[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NK; i++)
  ...
  #pragma acc data copy(C[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NJ; i++)
  ...
  #pragma acc data copy(D[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NM; i++)
...
void compareResults(DATA_TYPE *G, DATA_TYPE *G_outputFromGpu)
{
  ...
  #pragma acc data copy(G[0:262656],G_outputFromGpu[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i=0; i < NI; i++)
...
void mm3_cpu(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C, DATA_TYPE *D, DATA_TYPE *E, DATA_TYPE *F, DATA_TYPE *G)
{
  ...
  /* E := A*B */
  #pragma acc data copy(A[0:262656],B[0:262656],E[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NI; i++)
  ...
  /* F := C*D */
  #pragma acc data copy(C[0:262656],D[0:262656],F[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NJ; i++)
  ...
  /* G := E*F */
  #pragma acc data copy(E[0:262656],F[0:262656],G[0:262656])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NI; i++)
