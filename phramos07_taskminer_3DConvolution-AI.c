...
void conv3D(DATA_TYPE* A, DATA_TYPE* B)
{
  ...
  #pragma acc data copy(B[262657:134217727],A[0:134480384])
  #pragma acc kernels
...
#pragma omp parallel for
  #pragma acc data copy(A[0:134480384],B[262657:134217727])
  #pragma acc kernels
  #pragma acc loop independent
  for (j = 1; j < NJ - 1; ++j)
    {
...
void init(DATA_TYPE* A)
{
  ...
  #pragma acc data copy(A[0:134480384])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NI; ++i)
...
void compareResults(DATA_TYPE* B, DATA_TYPE* B_GPU)
{
  ...
  #pragma acc data copy(B_GPU[262657:134217727],B[262657:134217727])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 1; i < NI - 1; ++i)
