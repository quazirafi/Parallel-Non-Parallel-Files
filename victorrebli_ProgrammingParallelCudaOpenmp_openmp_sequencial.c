...
void matriz_seq(float **A,float **B,float **C)
{
...
void matriz_openmp(float **A,float **B,float **C)
{
int i,j,k,y,x,z,l,l1,p,m;
float sum;
srand ( time(NULL) );
...
float **A, **B, **C;
   ...
   A = malloc (N * sizeof (float *));
					dummyMethod3();
   for (h = 0; h < N; ++h)
      A[h] = malloc (N * sizeof (float));
					dummyMethod4();

    B = malloc (N * sizeof (float *));
					dummyMethod3();
   for (h = 0; h < N; ++h)
      B[h] = malloc (N * sizeof (float));
					dummyMethod4();

    C = malloc (N * sizeof (float *));
					dummyMethod3();
   for (h = 0; h < N; ++h)
      C[h] = malloc (N * sizeof (float));
					dummyMethod4();
...
for(l=0;l<N;l++) {
for(l1=0;l1<N;l1++) {
A[l][l1]= ((float)rand()/(float)(RAND_MAX)) * 3.0;
B[l][l1]= ((float)rand()/(float)(RAND_MAX)) * 3.0;
C[l][l1] = 0.0;
}
}
dummyMethod4();
