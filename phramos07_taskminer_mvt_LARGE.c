...
#pragma omp parallel for collapse(1)
  ...
  RST_AI1 |= !((a + 0 > y2 + 2048)
  || (y2 + 0 > a + 4194304));
  RST_AI1 |= !((x1 + 0 > x2 + 2048)
  || (x2 + 0 > x1 + 2048));
  RST_AI1 |= !((x1 + 0 > y1 + 2048)
  || (y1 + 0 > x1 + 2048));
  RST_AI1 |= !((x1 + 0 > y2 + 2048)
  || (y2 + 0 > x1 + 2048));
  RST_AI1 |= !((x2 + 0 > y1 + 2048)
  || (y1 + 0 > x2 + 2048));
  RST_AI1 |= !((x2 + 0 > y2 + 2048)
  || (y2 + 0 > x2 + 2048));
  RST_AI1 |= !((y1 + 0 > y2 + 2048)
  || (y2 + 0 > y1 + 2048));
  #pragma omp target data map(to: a[0:4194304],y1[0:2048],y2[0:2048]) map(tofrom: x1[0:2048],x2[0:2048]) if(!RST_AI1)
  {
