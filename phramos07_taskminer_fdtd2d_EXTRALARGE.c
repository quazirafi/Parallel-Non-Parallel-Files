...
void GPU__runFdtd(DATA_TYPE *restrict _fict_, DATA_TYPE *restrict ex,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !((_fict_ + 0 > ex + 5762400)
  || (ex + 0 > _fict_ + 1000));
  RST_AI1 |= !((_fict_ + 0 > ey + 5762400)
  || (ey + 0 > _fict_ + 1000));
  RST_AI1 |= !((_fict_ + 0 > hz + 5760000)
  || (hz + 0 > _fict_ + 1000));
  RST_AI1 |= !((ex + 0 > ey + 5762400)
  || (ey + 0 > ex + 5762400));
  RST_AI1 |= !((ex + 0 > hz + 5760000)
  || (hz + 0 > ex + 5762400));
  RST_AI1 |= !((ey + 0 > hz + 5760000)
  || (hz + 0 > ey + 5762400));
  #pragma omp target data map(to: _fict_[0:1000]) map(tofrom: ex[0:5762400],ey[0:5762400],hz[0:5760000]) if(!RST_AI1)
