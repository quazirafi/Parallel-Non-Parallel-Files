...
void GPU__runFdtd(DATA_TYPE *restrict _fict_, DATA_TYPE *restrict ex,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !((_fict_ + 0 > ex + 6480)
  || (ex + 0 > _fict_ + 40));
  RST_AI1 |= !((_fict_ + 0 > ey + 6480)
  || (ey + 0 > _fict_ + 40));
  RST_AI1 |= !((_fict_ + 0 > hz + 6400)
  || (hz + 0 > _fict_ + 40));
  RST_AI1 |= !((ex + 0 > ey + 6480)
  || (ey + 0 > ex + 6480));
  RST_AI1 |= !((ex + 0 > hz + 6400)
  || (hz + 0 > ex + 6480));
  RST_AI1 |= !((ey + 0 > hz + 6400)
  || (hz + 0 > ey + 6480));
  #pragma omp target data map(to: _fict_[0:40]) map(tofrom: ex[0:6480],ey[0:6480],hz[0:6400]) if(!RST_AI1)
