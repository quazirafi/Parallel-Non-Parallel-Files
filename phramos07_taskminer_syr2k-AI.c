...
void init_arrays(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C, DATA_TYPE *C_GPU)
{
  ...
  #pragma acc data copy(C[0:4196352],C_GPU[0:4196352],B[0:4196352],A[0:4196352])
  #pragma acc kernels
...
void syr2k(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C)
{
  ...
  #pragma acc data copy(C[0:4196352])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < N; i++)
  ...
  #pragma acc data copy(A[0:4196352],B[0:4196352],C[0:4196352])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < N; i++)
...
void compareResults(DATA_TYPE *C, DATA_TYPE *C_outputFromGpu)
{
  ...
  // Compare C with D
  #pragma acc data copy(C[0:4196352],C_outputFromGpu[0:4196352])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i=0; i<N; i++)
