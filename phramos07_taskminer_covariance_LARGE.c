...
#pragma omp parallel for
  ...
  || (mean + 1 > data + 1049599));
  RST_AI1 |= !((data + 1026 > symmat + 1049599)
  || (symmat + 1026 > data + 1049599));
  RST_AI1 |= !((mean + 1 > symmat + 1049599)
  || (symmat + 1026 > mean + 1024));
  #pragma omp target data map(tofrom: data[1026:1049599],mean[1:1024],symmat[1026:1049599]) if(!RST_AI1)
  {
