...
void GPU__syr2k(DATA_TYPE *restrict A, DATA_TYPE *restrict B,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !((A + 0 > B + 5760000)
  || (B + 0 > A + 5760000));
  RST_AI1 |= !((A + 0 > C + 5760000)
  || (C + 0 > A + 5760000));
  RST_AI1 |= !((B + 0 > C + 5760000)
  || (C + 0 > B + 5760000));
  #pragma omp target data map(to: A[0:5760000],B[0:5760000]) map(tofrom: C[0:5760000]) if(!RST_AI1)
