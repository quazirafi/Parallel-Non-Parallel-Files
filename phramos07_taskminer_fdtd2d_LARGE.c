...
void GPU__runFdtd(DATA_TYPE *restrict _fict_, DATA_TYPE *restrict ex,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !((_fict_ + 0 > ex + 1441200)
  || (ex + 0 > _fict_ + 500));
  RST_AI1 |= !((_fict_ + 0 > ey + 1441200)
  || (ey + 0 > _fict_ + 500));
  RST_AI1 |= !((_fict_ + 0 > hz + 1440000)
  || (hz + 0 > _fict_ + 500));
  RST_AI1 |= !((ex + 0 > ey + 1441200)
  || (ey + 0 > ex + 1441200));
  RST_AI1 |= !((ex + 0 > hz + 1440000)
  || (hz + 0 > ex + 1441200));
  RST_AI1 |= !((ey + 0 > hz + 1440000)
  || (hz + 0 > ey + 1441200));
  #pragma omp target data map(to: _fict_[0:500]) map(tofrom: ex[0:1441200],ey[0:1441200],hz[0:1440000]) if(!RST_AI1)
