...
#pragma omp parallel for
  char RST_AI1 = 0;
  RST_AI1 |= !((data + 130 > mean + 128)
  || (mean + 1 > data + 16511));
  RST_AI1 |= !((data + 130 > symmat + 16511)
  || (symmat + 130 > data + 16511));
  RST_AI1 |= !((mean + 1 > symmat + 16511)
  || (symmat + 130 > mean + 128));
  #pragma omp target data map(tofrom: data[130:16511],mean[1:128],symmat[130:16511]) if(!RST_AI1)
  {
