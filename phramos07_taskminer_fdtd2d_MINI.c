...
void GPU__runFdtd(DATA_TYPE *restrict _fict_, DATA_TYPE *restrict ex,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !((_fict_ + 0 > ex + 420)
  || (ex + 0 > _fict_ + 20));
  RST_AI1 |= !((_fict_ + 0 > ey + 420)
  || (ey + 0 > _fict_ + 20));
  RST_AI1 |= !((_fict_ + 0 > hz + 400)
  || (hz + 0 > _fict_ + 20));
  RST_AI1 |= !((ex + 0 > ey + 420)
  || (ey + 0 > ex + 420));
  RST_AI1 |= !((ex + 0 > hz + 400)
  ...
  RST_AI1 |= !((ey + 0 > hz + 400)
  || (hz + 0 > ey + 420));
  #pragma omp target data map(to: _fict_[0:20]) map(tofrom: ex[0:420],ey[0:420],hz[0:400]) if(!RST_AI1)
