...
void conv2D(DATA_TYPE* A, DATA_TYPE* B)
{
  ...
  #pragma acc data copy(B[8193:67108863],A[0:67117056])
  #pragma acc kernels
...
void conv2D_OMP(DATA_TYPE* A, DATA_TYPE* B)
{
  ...
  #pragma acc data copy(A[0:67117056],B[8193:67108863])
  #pragma acc kernels
  #pragma acc loop independent
  for (i = 1; i < NI - 1; ++i)
    {
...
void init(DATA_TYPE* A)
{
  ...
  #pragma acc data copy(A[0:67117056])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i = 0; i < NI; ++i)
...
void compareResults(DATA_TYPE* B, DATA_TYPE* B_GPU)
{
  ...
  // Compare B and B_GPU
  #pragma acc data copy(B_GPU[8193:67108863],B[8193:67108863])
  #pragma acc kernels
  #pragma acc loop independent
			dummyMethod3();
  for (i=1; i < (NI-1); i++) 
