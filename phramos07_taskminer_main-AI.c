...
void compareResults(fp *image, fp *image_cpu, int Ne)
{
  ...
  AI1[2] = 4 * AI1[1];
  AI1[3] = AI1[2] / 4;
  #pragma acc data copy(image[0:AI1[3]],image_cpu[0:AI1[3]])
  #pragma acc kernels
...
int main(int argc, char *argv[]) {
	...
	AI1[2] = 4 * AI1[1];
	AI1[3] = AI1[2] / 4;
	#pragma acc data copy(iN[0:AI1[3]],iS[0:AI1[3]])
	#pragma acc kernels
	#pragma acc loop independent
	dummyMethod3();
	for (i = 0; i < Nr; i++) {
	...
	AI2[2] = 4 * AI2[1];
	AI2[3] = AI2[2] / 4;
	#pragma acc data copy(jW[0:AI2[3]],jE[0:AI2[3]])
	#pragma acc kernels
	#pragma acc loop independent
	dummyMethod3();
	for (j = 0; j < Nc; j++) {
	...
	AI3[3] = 4 * AI3[2];
	AI3[4] = AI3[3] / 4;
	#pragma acc data copy(image[0:AI3[4]],image_cpu[0:AI3[4]])
	#pragma acc kernels
	#pragma acc loop independent
	dummyMethod3();
	...
	for (iter = 0; iter < niter; iter++) {// do for the number of iterations input parameter
		...
		AI4[11] = AI4[10] * 1;
		AI4[12] = AI4[11] / 4;
		#pragma acc data copy(image_cpu[0:AI4[12]])
		#pragma acc kernels
		#pragma acc loop independent
	...
	for (iter = 0; iter < niter; iter++) {// do for the number of iterations input parameter
		...
		AI5[11] = AI5[10] * 1;
		AI5[12] = AI5[11] / 4;
		#pragma acc data copy(image[0:AI5[12]])
		#pragma acc kernels
		#pragma acc loop independent
		for (i = r1; i <= r2; i++) {		// do for the range of rows in ROI
			for (j = c1; j <= c2; j++) {// do for the range of columns in ROI
	...
	AI6[3] = 4 * AI6[2];
	AI6[4] = AI6[3] / 4;
	#pragma acc data copy(image[0:AI6[4]],image_cpu[0:AI6[4]])
	#pragma acc kernels
	#pragma acc loop independent
